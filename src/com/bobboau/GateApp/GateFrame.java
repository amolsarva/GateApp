...
public class GateFrame extends JFrame implements GateAppType.GateAppListener
{
	...
	private ArrayList<Vertex_people> Peoples = new ArrayList<Vertex_people>();
	private ArrayList<edge_relation> relation = new ArrayList<edge_relation>();
...
//		JSplitPane contents = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,new JScrollPane(sub_contents),new JScrollPane(mid_elements));
	...
	private void onSelectedDocumentChanged(int document)
	{
		this.the_app.getDocumentContent(document, new GateAppType.ResultRetriever(){
			...
			@Override
			public void People(ArrayList<Vertex_people> people) {

				
			}

			@Override
			public void Relations(ArrayList<edge_relation> relations) {
		...
		this.the_app.getDocumentSubject(document, new GateAppType.ResultRetriever(){
			...
			@Override
			public void People(final ArrayList<Vertex_people> people) {
				// TODO Auto-generated method stub			
			}

			@Override
			public void Relations(final ArrayList<edge_relation> relations) {
				// TODO Auto-generated method stub
			}
			
		});
		this.the_app.getDocumentPeople(document, new GateAppType.ResultRetriever(){
			@Override
			public void string(final String value){
			}
			public void People(final ArrayList<Vertex_people> people) {
		...
		this.the_app.getDocumentRelations(document, new GateAppType.ResultRetriever(){
			@Override
			public void string(final String value){
			}
			public void People(final ArrayList<Vertex_people> people) {
